...
function apiServer(client, backend) {
  ...
  const host = url.parse(client.serverUrl).host;
  ...
  async function run() {
      ...
      console.log(client.name, 'client listening on port', client.port);
  }
